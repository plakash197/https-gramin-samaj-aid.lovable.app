...
export default function HeroPage() {
  ...
  const messages = {
    hi: `"Namaste! Bharat Sahayak mein aapka swagat hai.

Samasya Badi Hai, Isliye Iska Samadhan Zaruri Hai:
Aaj hamara desh tarakki toh kar raha hai, lekin hamare gaon aur shehron ke beech ek bahut bada 'Digital Gap' hai. Ek aam insaan aaj bhi bhrashtachar (Corruption) aur kanooni pechidegiyon mein fasa hua hai.
...
Jankari ki Kami: Sarkari yojanaayein aati hain, par unka labh bicholiye (middlemen) utha le jaate hain kyunki aam nagrik ko apne sahi hakh ki jankari nahi hoti.
...
Ye sirf ek app nahi hai, ye ek Sashakt Bharat ki shuruat hai. Main ise hamesha free rakhunga taaki har bhartiya apne hakh ko jaan sake."`,
    en: `"नमस्ते! भारत सहायक में आपका स्वागत है।
...
Jankari Ki Kami: Sarkari yojanaayein आती है हैं, पर उनका लाभ बिचौलिये (बिचौलिए) उठा ले जाते हैं क्योंकि आम नागरिक को अपने सही हक की जानकारी नहीं होती।

किसानों की लड़ाई: मंडी में फसल का सही दाम न मिलना और बीज से लेकर खाद तक में धोखा होना एक कड़वी सच्ची है।

मैने भारत सहायक क्यू बनाया?
मैं एक 12वीं पास लड़का हूं, और मैंने देखा है कि कैसे जानें बिना लोग परेशान होते हैं। मैंने कहा कि मैं एआई (आर्टिफिशियल इंटेलिजेंस) जैसी आधुनिक तकनीक को हर इंसान तक पहुंचाऊंगा जिसे इसकी सबसे ज्यादा जरूरत है।
...
शुद्ध परख: मिलावत के खिलाफ आपकी ढाल, ताकि आप और आपका परिवार सुरक्षित रहे।
...
ये सिर्फ एक ऐप नहीं है, ये एक सशक्त भारत की शुरुआत है। मैं इसे हमेशा फ्री रखूंगा ताकि हर भारतीय अपने हक को जान सके।”`,
  };
