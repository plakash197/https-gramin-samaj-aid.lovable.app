...
  onComplete: (name: string, language: 'hi' | 'en' | 'hinglish') => void;
}
...
  const handleLanguageSelect = (lang: 'hi' | 'en' | 'hinglish') => {
...
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
            >
              Hinglish (हिंग्लिश)
            </button>
          </div>
...
            {selectedLanguage === 'hinglish' && 'Aapka naam kya hai?'}
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            {selectedLanguage === 'hi' && 'हम आपको नाम से संबोधित करेंगे'}
            {selectedLanguage === 'en' && 'We will address you by your name'}
            {selectedLanguage === 'hinglish' && 'Hum aapko naam se address karenge'}
          </p>
        </div>
...
            {selectedLanguage === 'hinglish' && 'Shuru Karein'}
          </button>
...
            {selectedLanguage === 'hinglish' && 'Language Change Karein'}
          </button>
        </div>
      </div>
    </div>
